...
export const WorksCard = ({ post }: Props) => {
  return (
    <div className="flex flex-col rounded-xl shadow-xl overflow-hidden">
      ...
      <div className="flex-1 bg-white dark:bg-slate-700 p-6 flex flex-col justify-between">
        <div className="flex-1">
          ...
          <div className="block mt-2">
            <h3 className="text-xl font-semibold text-basic-color-200">
              {post.title ?? post.slug}
            </h3>
            <div className="mt-3 text-base text-basic-color-100">
              {post.excerpt}
            </div>
          </div>
        </div>
        <div className="mt-6 flex items-center">
          <div className="ml-3">
            <div className="flex space-x-1 text-sm text-basic-color-100">
